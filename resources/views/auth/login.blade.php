...
<div class="auth-card">
    ...
    <div class="card-photo">
        <img src="{{ asset('images/bgHome2.png') }}"
             alt="Om Brew"
             onerror="this.style.display='none'; document.getElementById('fb-login').style.display='flex';">
        <div id="fb-login" class="photo-fallback" style="display:none;">
    ...
    <div class="card-form">
        ...
        @if (session('status'))
        <div class="err-msg" style="background:#f0fdf4;border-color:#bbf7d0;color:#166534;">
            {{ session('status') }}
        </div>
        @endif
        ...
        <form method="POST" action="{{ route('login') }}" style="width:100%;">
            ...
            <div class="input-wrap">
                ...
                <span class="toggle-eye" onclick="togglePw('pw-login','eye-login')">
            ...
            <div class="link-row">
                ...
                <a href="{{ route('password.request') }}">Belum Punya Akun?</a>
                @else
                <a href="{{ route('register') }}">Belum Punya Akun?</a>
                @endif
                <a href="{{ route('register') }}" class="highlight">Register Here</a>
            </div>
        ...
        <div class="social-wrap">
            <!-- Google -->
            <button class="btn-social" type="button" title="Login dengan Google">
            ...
            <!-- Facebook -->
            <button class="btn-social fb" type="button" title="Login dengan Facebook">
                <svg viewBox="0 0 24 24">
